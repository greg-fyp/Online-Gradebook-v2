...
class TeacherHomeView extends TeacherView {
		...
		$this->html_output .= <<< HTML
			...
			<div class='row mt-2'>
				<div class='col-lg-2 col-md-4 col-sm-6'>
					<div class='p-1 text-center tile green mt-1' onclick="location.href='$target_file?route=teacher_groups'">
			...
			<div class='row mt-2'>
				...
				<div class='col-lg-2 col-md-4 col-sm-6'>
					<div class='p-1 text-center tile azure mt-1' onclick="location.href='$target_file?route=edit_teacher_password'">
						<div class='icon'><i class='icon-key'></i></div>
						Change Password
					</div>
				</div>
				<div class='col-lg-2 col-md-4 col-sm-6'>
					<div class='p-1 text-center tile blue mt-1' onclick="location.href='$target_file?route=teacher_support'">
						<div class='icon'><i class='icon-cog-alt'></i></div>
						Support
					</div>
				</div>
				<div class='col-lg-2 col-md-4 col-sm-6'>
					<div class='p-1 text-center tile red mt-1' onclick="location.href='$target_file?route=user_logout'">
