...
class AdministratorEditProfileView extends AdministratorView {
	private $result;
	...
	public function create() {
		$this->page_title = APP_NAME . ' Admin Update Profile';
		$this->createPage();
	}
						...
						<div class='card mb-4 box-shadow'>
							<div class='card-header'>
								<div class='row'>
									...
									<div class='col-lg-8'>
										<h4 class="my-0 font-weight-normal text-center">Admin Profile</h4>
									</div>
									<div class='col-lg-2'></div>
								</div>
							</div>
