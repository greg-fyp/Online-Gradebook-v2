...
class TeacherGroupsView extends TeacherView {
			...
			$output .= <<< HTML
				<td>
					<div class='text-center'>
						<button class='btn btn-info' onclick="location.href='$target_file?route=view_assessments&code=$var'">View Group</button>
					</div>
				</td>
			HTML;
			$output .= '</tr>';
