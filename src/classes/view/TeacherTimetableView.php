...
class TeacherTimetableView extends TeacherView {
	private $begin_date;
	...
	public function create() {
		$this->page_title = APP_NAME . ' Teacher Timetable';
		$this->createPage();
	}
							...
							<div class='col-lg-2'>
								<div class='row'>
									<div class='col-lg-6 col-sm-6'>
										<button class='btn btn-info' 
										onclick="location.href='$target_file?route=teacher_timetable&date=$last_monday'"><</button>
									</div>
									<div class='col-lg-6 col-sm-6'>
										<button class='btn btn-info'
										onclick="location.href='$target_file?route=teacher_timetable&date=$next_monday'">></button>
									</div>
								</div>
							</div>
						</div>
