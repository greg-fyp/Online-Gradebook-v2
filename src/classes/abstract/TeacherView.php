...
abstract class TeacherView extends TemplateView {
	...
	public function addPageContent() {
			...
			<body>
				<header>
					...
					<div class='collapse navbar-collapse' id='menubar'>
						<ul class='navbar-nav'>
							<li class='nav-item'>
								<a class='nav-link' href='$target_file?route=teacher_main'>Home</a>
							</li>
							<li class='nav-item'>
						...
						<div class='dropdown ml-auto'>
							...
							<div class='dropdown-menu dropdown-menu-right' aria-labelledby='submenu'>
								<a class='dropdown-item' href='$target_file?route=edit_teacher'><i class='icon-pencil'></i> Edit Profile</a>
								<a class='dropdown-item' href='$target_file?route=edit_teacher_password'><i class='icon-key'></i> 
								Change Password</a>
		...
		$this->html_output .= $this->addTeacherPageContent();
		$this->html_output .= $this->buildFooter();
	}

	abstract protected function addTeacherPageContent();
