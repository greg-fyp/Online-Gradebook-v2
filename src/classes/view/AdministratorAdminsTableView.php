...
class AdministratorAdminsTableView extends AdministratorView {
	public function __construct() {
		parent::__construct();
	}

	public function create() {
		$this->page_title = APP_NAME . ' Administrator Admins View';
		$this->createPage();
	}
		...
		$this->html_output .=  <<< HTML
						...
						<div class='card mb-4 box-shadow'>
							<div class='card-header'>
								<div class='row'>
									...
									<div class='col-lg-8'>
										<h4 class="my-0 font-weight-normal text-center">Administrators</h4>
									</div>
			...
			<div class='modal fade' id='more-modal' tabindex='-1' role='dialog' aria-labelledby='More information' aria-hidden='true'>
				...
				function continueDelete() {
					location.href = '$target_file?route=drop_admin&id=' + toDelete;
				}
			</script>
		HTML;
	}
	...
	private function buildTable() {
		$output = '';
		$target_file = ROOT_PATH;
		foreach ($this->personal_details['admins'] as $item) {
			...
			$added = $item['admin_added_timestamp'];
